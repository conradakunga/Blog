...
In yesterday's post, "[.NET 11 Preview - Enabling Zstandard Compression in Kestrel]({% post_url .NET 11 Preview - Enabling Zstandard Compression in Kestrel %})", we looked at how to enable [Zstandard](https://en.wikipedia.org/wiki/Zstd) content compression in [Kestrel](https://learn.microsoft.com/en-us/aspnet/core/fundamentals/servers/kestrel?view=aspnetcore-10.0).
