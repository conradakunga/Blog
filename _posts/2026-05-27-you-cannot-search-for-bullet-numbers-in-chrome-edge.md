...
You can see that **every week** the blog entries are numbered from `1` to 7, in [Roman numerals](https://en.wikipedia.org/wiki/Roman_numerals).
...
The blog itself is generated with [Jekyll](https://jekyllrb.com/), and the **source code** and **posts** of this blog, as a reminder, are available [here](https://github.com/conradakunga/Blog).
