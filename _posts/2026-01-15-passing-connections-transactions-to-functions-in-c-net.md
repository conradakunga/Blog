---
layout: post
title: Passing Connections & Transactions To Functions In C# & .NET
...
In this example, I used a [SQL Server](https://www.microsoft.com/en-us/sql-server/) [SqlConnection](https://learn.microsoft.com/en-us/dotnet/api/microsoft.data.sqlclient.sqlconnection?view=sqlclient-dotnet-core-6.1), but the exact same principles will work with any kind of connection - [PostgreSQL](https://www.postgresql.org/), [SQLite](https://sqlite.org/), [MySQL](https://www.mysql.com/), [Oracle](https://www.oracle.com/database/), etc.
