...
To my pleasant surprise, [eza](https://github.com/eza-community/eza) is **available** in Windows
...
[Winget](https://learn.microsoft.com/en-us/windows/package-manager/winget/) will download and install the software.
...
2. Much as **PowerShell** supports [aliases](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.utility/set-alias?view=powershell-7.6), you [cannot create an alias for a command with a parameter.](https://learn.microsoft.com/en-us/powershell/scripting/learn/shell/using-aliases?view=powershell-7.5#creating-alternate-names-for-commands-with-parameters) You have to create a [function](https://learn.microsoft.com/en-us/powershell/scripting/learn/ps101/09-functions?view=powershell-7.6) instead.
